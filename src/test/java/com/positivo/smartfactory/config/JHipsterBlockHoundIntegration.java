...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.positivo.smartfactory.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.positivo.smartfactory.security.DomainUserDetailsService", "createSpringSecurityUser");
